...
export function BonusBox() {
  ...
  return (
    <div className="grid grid-cols-2 grid-rows-1 gap-1 xs:gap-2 text-base md:text-xl rounded-md">
      ...
      <p className="justify-self-start flex items-center justify-center text-center font-extrabold outline-2 border-blue-900 text-sm rounded-full bg-blue-100 shadow-md aspect-square max-h-[calc(100vh/12)]">
